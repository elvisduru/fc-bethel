...
export class Partners extends Component {
  ...
  handleSubmit = () => {
    const fields = { ...this.state.fields };
    axios.post('/api/partnership', fields)
      .then(response => {
            ...
            {this.state.messageSent ? (
              <Bounce top>
                ...
                <div className={styles.form}>
                  ...
                  <input style={this.state.error ? { borderColor: 'orangered' } : null} name="name" onChange={this.handleInput} type="text" placeholder="Name" />
                  ...
                  <textarea name="message" onChange={this.handleInput} placeholder="Message" />
